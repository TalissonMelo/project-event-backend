...
public class SpringDocumentation implements WebMvcConfigurer {
	...
	public Docket apiDocket() {
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.talissonmelo.projectevent.resources")).build().apiInfo(apiInfo());
	}
